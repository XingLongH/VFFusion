...
class FPNNeck(nn.Module):
    ...
    def forward(self, ms_feats):
        ...
        change1 = self.stage1_Conv1(torch.cat([fa1, fb1], 1))  # inplanes * 2
        change2 = self.stage2_Conv1(torch.cat([fa2, fb2], 1))  # inplanes * 4
        change3 = self.stage3_Conv1(torch.cat([fa3, fb3], 1))  # inplanes * 8 
