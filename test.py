...
def main(opt): 
    ...
    with torch.no_grad():
        ...
        for it, (images_vis, images_ir,name) in enumerate(test_loader):
            ...
            image_vis_ycrcb1 =image_vis_ycrcb[:,0,:,:] .unsqueeze(1)
            
            A = 1
            logits, outputs1, outputs2 = fusionmodel(image_vis_ycrcb1, images_ir, A)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run VFFusion with pytorch')
    parser.add_argument('--model_name', '-M', type=str, default='VFFusion')
    parser.add_argument("--backbone", type=str, default="VFFusion_64")
